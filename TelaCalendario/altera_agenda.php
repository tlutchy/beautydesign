...
$comandoSql = "update agenda set titulo_agenda = '$titulo', id_cliente = '$cliente', id_funcionario = '$funcionario', id_servico = '$servico', data_agenda = '$data', horainicio_agenda = '$hora', obs_agenda = '$obs', status_agenda = '$status', corstatus_agenda = '$cor_agenda' where id_agenda = '$id'";
