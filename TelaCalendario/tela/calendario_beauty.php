        ...
        init: function(themeSystem) {
          calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            select: function(info) {
              ...
              $('#cadastrar #data').val(info.start.toLocaleString());
            },
            events: [
              <?php
...
<body>
        ...
        <div class="modal-body">
          ...
          <form action="cadastra_agenda_beauty.php" class="form" name="form" id="form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" id="form-data">
              <input type="date" name="data" id="data" class="form-control rounded-left" onkeyup="mascara_data(this, this.value)" maxlength="10">
              <i class="fas fa-exclamation-circle"></i>
              <i class="fas fa-check-circle"></i>
              <small>Mensagem de erro</small>
            </div>
            ...
            <div class="modal-footer">
              <div class="col-sm-10">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="submit" name="cadastrar" id="cadastrar" class="btn btn-success" value="cadastrar" onclick="confirmarCadastro()">Cadastrar</button>
              </div>
            </div>
          </form>
        </div>
  ...
  <div class="modal fade" id="mostrarSuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agenda</h5>
