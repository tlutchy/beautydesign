        ...
        <div class='col-md-6 col-lg-5'>
            <div class='row vh-100 login-wrap rounded align-items-center justify-content-center mx-0'>
                <div class='col-md-6 text-center p-4'>
                    ...
                    <p class='mb-4'>Você não tem permissão para acessar essa página</p>
                    <input class='btn btn-primary rounded-pill py-3 px-5' type='button' value='Voltar' onclick='history.go(-1)' />
