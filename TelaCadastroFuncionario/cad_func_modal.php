                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="login-wrap p-4 p-md-5">
                                ...
                                <h3 class="text-center mb-4">ALTERAR FUNCIONÁRIO</h3>
                                <?php

                                if (isset($_POST['altera'])) {
                                    $all_id = $_POST['checkbox_id'];
                                    $funcId = implode(',', $all_id);
                                    //echo $extrai_id;
                                ...
                                $comandoSql = "select * from funcionario where id_funcionario='$funcId'";
                                $resultado = mysqli_query($con, $comandoSql);
                                ...
                                <form action="altera_funcionario.php" class="form" id="form" method="post">
                                    <input name="id" id="id" value="<?php echo $id_func ?>" hidden>
                                    <div class="form-group" id="form-nome">
                                        <input type="text" name="nome" id="nome" class="form-control rounded-left" placeholder="Nome" value="<?php echo $nome_func ?>">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <i class="fas fa-check-circle"></i>
                                        <small>Mensagem de erro</small>
                                    </div>
                                    <div class="form-group" id="form-cpf">
                                        <input type="text" name="cpf" id="cpf" class="form-control rounded-left" placeholder="CPF" value="<?php echo $cpf_func ?>">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <i class="fas fa-check-circle"></i>
                                        <small>Mensagem de erro</small>
                                    </div>
                                    <div class="form-group" id="form-fone">
                                        <input type="text" name="fone" id="fone" class="form-control rounded-left" placeholder="Telefone" value="<?php echo $fone_func ?>">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <i class="fas fa-check-circle"></i>
                                        <small>Mensagem de erro</small>
                                    </div>
