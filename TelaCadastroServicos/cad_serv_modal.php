            ...
            <div class="sidebar pb-3">
                <nav class="navbar navbar-dark">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="../TelaCadastroServicos/frm_cad_serv_painel.php" class="nav-item nav-link active"><i class="fa-solid fa-briefcase me-2"></i></i>Serviços</a>
            ...
            <form action="exclui_servicos.php" method="POST">
                <div class="container-fluid pt-4 px-4">
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <button disabled type="submit" formaction="cad_serv_modal.php" id="altera" name="altera" class="ms-2 btn-header"><i class="fa-solid fa-pen"></i>Alterar</button>
                        </div>
                    </div>
                </div>
                <!-- Sale & Revenue End -->
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-secondary text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">Todos os Serviços</h3>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="login-wrap p-4 p-md-5">
                                ...
                                <h3 class="text-center mb-4">ALTERAR SERVIÇO</h3>
                                <?php

                                if (isset($_POST['altera'])) {
                                    $all_id = $_POST['checkbox_id'];
                                    $servId = implode(',', $all_id);
                                    //echo $extrai_id;
                                ...
                                $comandoSql = "select * from servico where id_servico='$servId'";
                                $resultado = mysqli_query($con, $comandoSql);
                                ...
                                $valor_serv = $dados["valor"];
                                ?>
                                <form action="altera_servico.php" class="form" id="form" method="post">
                                    <input name="id" id="id" value="<?php echo $id_serv ?>" hidden>
                                    <div class="form-group" id="form-nome">
                                        <input type="text" name="nome" id="nome" class="form-control rounded-left" placeholder="Serviço" value="<?php echo $nome_serv ?>">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <i class="fas fa-check-circle"></i>
                                        <small>Mensagem de erro</small>
                                    </div>
                                    <div class="form-group" id="form-valor">
                                        <input type="number" name="valor" id="valor" class="form-control rounded-left" step="0.01" min="0.01" placeholder="Valor" value="<?php echo $valor_serv?>">
                                        <i class="fas fa-exclamation-circle"></i>
                                        <i class="fas fa-check-circle"></i>
                                        <small>Mensagem de erro</small>
                                    </div>
